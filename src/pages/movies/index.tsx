                    ...
                    <div className="flex min-w-0 grow flex-col justify-between py-2">
                      <div className="space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          >
                            {movie.showingStatus === ShowingStatus.NOW_SHOWING ? "Đang chiếu" : "Sắp chiếu"}
                          </span>
                        ...
                        <div className="flex items-center gap-3">
                          <span className="flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 text-xs font-black tracking-tighter text-white/60 uppercase ring-1 ring-white/5">
                            <Clock className="h-3.5 w-3.5" />{movie.duration} MINUTES
                          </span>
                      ...
                      <div className="mt-8 flex items-center gap-4">
                        <button
                          onClick={() => navigate(URL.MovieDetail.replace(":id", movie._id))}
                          className="cursor-pointer rounded-full bg-[#d4af37] px-10 py-3.5 text-sm font-black tracking-[0.2em] text-black uppercase shadow-xl transition-all active:scale-95 hover:-translate-y-1 duration-300"
                        >
                          Đặt vé ngay
                        </button>
          ...
          return (
            ...
            >
              <div className="relative aspect-2/3 overflow-hidden rounded-[2.5rem] border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,1)]">
                ...
                {sectionType === "NOW" && (
                  <div className="absolute flex items-center top-5 left-5 rounded-full bg-[#fedb39] px-4 py-2 text-sm font-black tracking-[0.2em] text-black uppercase shadow-2xl ring-4 ring-black/50">
